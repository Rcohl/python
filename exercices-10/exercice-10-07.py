...
resultat1 = tax_type_1_price = compute_tax(100, 1)
resultat2 = tax_type_2_price = compute_tax(100, 2)
resultat3 = tax_type_3_price = compute_tax(100, 3)
resultat4 = tax_type_4_price = compute_tax(100, 4)
